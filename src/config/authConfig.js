...
export const COGNITO_CONFIG = {
  ...
  userPoolId: import.meta.env.VITE_COGNITO_USER_POOL_ID || 'us-east-1_ZjVTgRMTo',
  userPoolClientId: import.meta.env.VITE_COGNITO_USER_POOL_CLIENT_ID || '5tccouindp8mh83f3kklrr659c',
  oauth: {
