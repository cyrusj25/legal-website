...
export const SELLER_DOCUMENT_DEFINITIONS = [
  { key: 'Doc1', code: 'SA01' },
  { key: 'Doc2', code: 'SP01' },
  { key: 'Doc3', code: 'SI01' },
]

export const PROPERTY_DOCUMENT_DEFINITIONS = [
  { key: 'Ekatha', code: 'EK01' },
  { key: 'Past Sale deed', code: 'SD01' },
  { key: 'Encumbrance Certificate (EC)', code: 'EC01' },
]

export const HOME_LATEST_UPDATES = [
  {
...
export const HOME_SPOTLIGHT_ITEMS = [
